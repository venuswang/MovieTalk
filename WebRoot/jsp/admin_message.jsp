							...
							<div class="col-sm-8">
								<form class="form-horizontal mt15" id="user_form" action="#">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" disabled="disabled" value="${mAdmin.uname}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">用户名：</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" disabled="disabled" value="${mAdmin.fullname}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">手机号码：</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" disabled="disabled" value="${mAdmin.phone}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">电子邮箱：</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" disabled="disabled" value="${mAdmin.email}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <a class="king-btn king-default" title="修改" href="admin/admin_message_edit">
                                                <i class="fa fa-mail-reply-all btn-icon"></i>修改
                                            </a>
                                        </div>
                                        <label class="col-sm-2 control-label"></label>
                                        <label class="col-sm-2 control-label"></label>
