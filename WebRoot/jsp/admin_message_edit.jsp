							...
							<div class="col-sm-8">
								<div class="form-horizontal mt15">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        	<input type="hidden" id="admin_id" value="${mAdmin.id}" />
                                            <input type="text" class="form-control" disabled="disabled" id="uname" value="${mAdmin.uname}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="请填写用户名" id="fullname" value="${mAdmin.fullname}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">手机号码：</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="请填写手机号码" id="phone" value="${mAdmin.phone}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">电子邮箱：</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="请填写电子邮箱" id="email" value="${mAdmin.email}">
                                            <span class="king-required-tip text-danger ml5">*</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                           <button class="king-btn king-info mr10" title="保存" onclick="admin_message_edit()">
                                                <i class="fa fa-save btn-icon"></i>保存
                                            </button>
                                        </div>
                                        <label class="col-sm-2">
                                        	<button type="reset" class="king-btn king-default" title="重置" onclick="admin_mess_clear()">
