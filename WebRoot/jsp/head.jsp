            ...
            <div class="container">
                ...
                <div class="">
                  <ul class="nav navbar-nav navbar-left">
                    ...
                    <li><a href="common/all_tag"><span>标签</span></a></li>
                    <li><a href="common/all_long_reviews/1/10"><span>影片长评</span></a></li>
                    <c:if test="${sessionScope.username != null}">
                    	<li class="active"><a href="custom/all_movie_collect/1/10"><span>收藏影片列表</span></a></li>
                    </c:if>
                  </ul>
                  <ul class="nav navbar-nav navbar-right">
                   	<c:choose>
						...
						<c:otherwise>
							<li class="disuser"><a style="color:#fff;">${sessionScope.username}</a></li>
							<li><a href="custom/user_exit">退出</a></li>
						</c:otherwise>
					</c:choose>
                  </ul>
                </div>
